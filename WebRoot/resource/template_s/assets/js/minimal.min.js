var widthLess1024 = function() {
	if ($(window).width() < 1024) {
		...
		$("#navigation").find(".dropdown-menu.animated")
...
$(function() {
	...
	$(".sidebar-collapse a").on(
			"click",
			function() {
				$("#sidebar, #navbar").toggleClass("collapsed");
				$("#navigation").find(".dropdown.open").removeClass("open");
				$("#navigation").find(".dropdown-menu.animated").removeClass(
						"animated");
				...
				.videobackground(
						{
							videoSource : [
									[
											"http://tattek.com/minimal/assets/videos/videobg.mp4",
											"video/mp4" ],
									[
											"http://tattek.com/minimal/assets/videos/videobg.webm",
											"video/webm" ],
									[
											"http://tattek.com/minimal/assets/videos/videobg.ogv",
											"video/ogg" ] ],
