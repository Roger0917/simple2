var App = function () {
	...
	var handleBackstretch = function () {
		 $.backstretch([
		"resource/template/img/login/1.jpg"
		, "resource/template/img/login/2.jpg"
		, "resource/template/img/login/3.jpg"
		, "resource/template/img/login/4.jpg"
	...
	var handleThemeSkins = function () {
        ...
        var setSkin = function (color) {
            $('#skin-switcher').attr("href", "/dcp/resource/template/css/themes/" + color + ".css");
