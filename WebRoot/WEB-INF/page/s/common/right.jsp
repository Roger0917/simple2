         ...
         <div class="tab-pane active" id="mmenu-users">
             ...
             <ul class="users-list">
                 ...
                 <li class="online">
                     <div class="media">
                         <a class="pull-left profile-photo" href="#">
                             <img class="media-object" src="${pageContext.request.contextPath}/resource/template_s/assets/images/ici-avatar.jpg" alt>
                         </a>
                 ...
                 <li class="online">
                     <div class="media">
                         ...
                         <a class="pull-left profile-photo" href="#">
                             <img class="media-object" src="${pageContext.request.contextPath}/resource/template_s/assets/images/arnold-avatar.jpg" alt>
                         </a>
                 ...
                 <li class="online">
                     <div class="media">
                         <a class="pull-left profile-photo" href="#">
                             <img class="media-object" src="${pageContext.request.contextPath}/resource/template_s/assets/images/peter-avatar.jpg" alt>
                 ...
                 <li class="online">
                     <div class="media">
                         <a class="pull-left profile-photo" href="#">
                             <img class="media-object" src="${pageContext.request.contextPath}/resource/template_s/assets/images/george-avatar.jpg" alt>
                         </a>
                         <div class="media-body">
                 ...
                 <li class="busy">
                     <div class="media">
                         <a class="pull-left profile-photo" href="#">
                             <img class="media-object" src="${pageContext.request.contextPath}/resource/template_s/assets/images/random-avatar1.jpg" alt>
                         </a>
                         <div class="media-body">
                 ...
                 <li class="busy">
                     <div class="media">
                         <a class="pull-left profile-photo" href="#">
                             <img class="media-object" src="${pageContext.request.contextPath}/resource/template_s/assets/images/random-avatar2.jpg" alt>
                         </a>
                         <div class="media-body">
             ...
             <ul class="users-list">
                 ...
                 <li class="offline">
                     <div class="media">
                         <a class="pull-left profile-photo" href="#">
                             <img class="media-object" src="${pageContext.request.contextPath}/resource/template_s/assets/images/random-avatar4.jpg" alt>
                         </a>
                         <div class="media-body">
                 ...
                 <li class="offline">
                     <div class="media">
                         ...
                         <a class="pull-left profile-photo" href="#">
                             <img class="media-object" src="${pageContext.request.contextPath}/resource/template_s/assets/images/random-avatar5.jpg" alt>
                         </a>
                 ...
                 <li class="offline">
                     <div class="media">
                         <a class="pull-left profile-photo" href="#">
                             <img class="media-object" src="${pageContext.request.contextPath}/resource/template_s/assets/images/random-avatar6.jpg" alt>
                 ...
                 <li class="offline">
                     <div class="media">
                         <a class="pull-left profile-photo" href="#">
                             <img class="media-object" src="${pageContext.request.contextPath}/resource/template_s/assets/images/random-avatar7.jpg" alt>
                         </a>
                         <div class="media-body">
                 ...
                 <li class="offline">
                     <div class="media">
                         <a class="pull-left profile-photo" href="#">
                             <img class="media-object" src="${pageContext.request.contextPath}/resource/template_s/assets/images/random-avatar8.jpg" alt>
                         </a>
                         <div class="media-body">
