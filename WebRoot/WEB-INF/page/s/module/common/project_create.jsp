...
<body class="bg-1">
	...
	<section class="">
        ...
        <div class="tile-body col-md-8">
          ...
          <form class="form-horizontal" role="form" action="${pageContext.request.contextPath}/s/project/save" id="pageForm">
            <div class="form-group">
              <label  class="col-sm-2 control-label">所属辖区</label>
              <div class="col-sm-4">
                <input type="text" id="parea" name="parea" class="typeahead parea" autocomplete="off" placeholder="输入关键字进行模糊查询">
            ...
            <div class="form-group">
              ...
              <div class="col-sm-4">
                <input type="text" class="form-control" name="buildUnit">
              	<span class="error"></span>
              </div>
              <label  class="col-sm-2 control-label">建设单位</label>
              <div class="col-sm-4">
                <input type="text" class="form-control" name="constructUnit">
              	<span class="error"></span>
              </div>
            </div>
            <div class="form-group">
			...
			var options = {
	                ...
	                success: function (data) {
	                	if(data=='success'){
		        			...
		        			form.submit();
		        			parent.layer.close(index);//上面的代码先执行刷新表单，再执行这里的关闭Layer
	                	}
	                }
	         };
	         $.ajax(options);
