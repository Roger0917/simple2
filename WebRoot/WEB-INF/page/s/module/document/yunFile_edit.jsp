...
<body class="bg-1">
	...
	<section class="">
        ...
        <div class="tile-body col-md-8">
          ...
          <form class="form-horizontal" role="form" action="${pageContext.request.contextPath}/s/yunfile/update" id="pageForm" method="post" enctype="multipart/form-data">
          	<input type="hidden" name="uk" value="${yunFile.uk}" id="uk"/>
            ...
            <div class="form-group">
              ...
              <div class="col-sm-7">
                <input type="text" class="form-control" name="number" id="number" value="${yunFile.number }">
            ...
            <div class="form-group">
              ...
              <div class="col-sm-7">
              	<span id="filename">
              		<a>${yunFile.name}</a><a href="javascript:showFileUpload()" class="btn btn-info">上传新文件</a>
              	</span>
                <input type="file" class="form-control" name="yunFile" id="file" style="display: none;" >
                <span class="errorStyle" id="error-file"></span>
              </div>
              <div class="col-sm-1" id="cancel" style="display: none;">
              	<span>
              		<a href="javascript:hiddenFileUpload()" class="btn btn-info">取消</a>
              	</span>
              </div>
            </div>
